...
#val_acc = 83
fixed_arc="0 3 0 1 1 1 1 4 0 0 1 4 1 1 0 0 1 3 1 1"
fixed_arc="$fixed_arc 0 3 1 0 1 4 0 4 1 1 1 1 1 1 1 4 1 1 1 0"

python src/cifar10/main.py \
  --data_format="NCHW" \
  --search_for="micro" \
  --reset_output_dir \
  --data_path="/disk1/zhaojiacheng/cifar/cifar10" \
  --output_dir="/disk1/zhaojiacheng/NAS/outputs" \
  --batch_size=144 \
  --num_epochs=630 \
  --log_every=50 \
  --eval_every_epochs=1 \
